...
const FriendRequestSidebarOptions = ({
  ...
  useEffect(() => {
    ...
    pusherClient.bind("new_friend", addedFriendHandler); // Binding
  ...
  return (
    ...
    >
      {/* Tip Tailwind: While using the "group" class in parent, if child has "group-hover" class then it will work */}
